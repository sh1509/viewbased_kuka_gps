...
(cl:defmethod cl:initialize-instance :after ((m <CalculateIK-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CalculateIK-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gps_agent_pkg-srv:<CalculateIK-request> is deprecated: use gps_agent_pkg-srv:CalculateIK-request instead.")))

(cl:ensure-generic-function 'poses-val :lambda-list '(m))
(cl:defmethod poses-val ((m <CalculateIK-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gps_agent_pkg-srv:poses-val is deprecated.  Use gps_agent_pkg-srv:poses instead.")
  (poses m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CalculateIK-request>)))
  ...
  "gps_agent_pkg/CalculateIKRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CalculateIK-request)))
  "Returns string type for a service object of type 'CalculateIK-request"
  "gps_agent_pkg/CalculateIKRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <CalculateIK-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CalculateIK-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gps_agent_pkg-srv:<CalculateIK-response> is deprecated: use gps_agent_pkg-srv:CalculateIK-response instead.")))

(cl:ensure-generic-function 'points-val :lambda-list '(m))
(cl:defmethod points-val ((m <CalculateIK-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gps_agent_pkg-srv:points-val is deprecated.  Use gps_agent_pkg-srv:points instead.")
  (points m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CalculateIK-response>)))
  ...
  "gps_agent_pkg/CalculateIKResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CalculateIK-response)))
  "Returns string type for a service object of type 'CalculateIK-response"
  "gps_agent_pkg/CalculateIKResponse")
