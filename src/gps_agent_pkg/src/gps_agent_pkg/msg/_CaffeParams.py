...
class CaffeParams(genpy.Message):
  _md5sum = "963140e466eb030de342c2ccf87872da"
...
uint32 dU
"""
  __slots__ = ['net_param','bias','scale','noise','dim_bias','dU']
  _slot_types = ['string','float32[]','float32[]','float32[]','int32','uint32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       net_param,bias,scale,noise,dim_bias,dU
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.noise))
      _x = self
      buff.write(_get_struct_iI().pack(_x.dim_bias, _x.dU))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.net_param = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      self.noise = s.unpack(str[start:end])
      _x = self
      start = end
      end += 8
      (_x.dim_bias, _x.dU,) = _get_struct_iI().unpack(str[start:end])
      return self
